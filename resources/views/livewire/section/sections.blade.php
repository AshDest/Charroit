         ...
         <div class="row ">
             <div class="col-12  align-self-center">
                 <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                     <div class="w-sm-100 mr-auto"><h4 class="mb-0">Section</h4></div>
                                 ...
                                 <div class="col-12">
                                     ...
                                     <form wire:submit.prevent="updates">
                                         <div class="form-group row">
                                             <label for="designation" class="col-sm-4 col-form-label">Section</label>
                                             <div class="col-sm-8">
                             ...
                             <table class="table">
                                 ...
                                 <tbody>
                                     ...
                                     <tr>
                                         ...
                                         <td>
                                             <button
                                                 class="btn btn-primary btn-sm"  wire:click="edit({{ $section->id }})">
                                                 <span class="icon-pencil" style="cursor: pointer"></span></span></button>
                                         </td>
                                         <td>
                                         <button
                                             class="btn btn-danger btn-sm" wire:click="delete({{ $section->id }})">
