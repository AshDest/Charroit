                ...
                <div class="col-12  align-self-center">
                    <div class="sub-header mt-3 py-3 align-self-center d-sm-flex w-100 rounded">
                        <div class="w-sm-100 mr-auto">
                            <h4 class="mb-0">Les Type Automobile</h4>
                        </div>
                ...
                <div class="col-12 col-sm-6 mt-3">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between align-items-center">
                            <h4 class="card-title">LISTES TYPE AUTOMOBILES</h4>
                            <div class="col-sm-5">
                            ...
                            <div class="col-auto ml-auto sm-2">
                                ...
                                <select id="page_active" wire:model.lazy="page_active" class="custom-select w-auto">
                                    @for ($i = 6; $i <= 12; $i +=3) <option value="{{ $i }}">{{ $i }}</option>
                                        @endfor
                                </select>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <button class="btn btn-primary btn-sm"
                                                    wire:click="edit({{ $typesmobile->id }})">
                                                    <span class="icon-pencil"
                                                        style="cursor: pointer"></span></span></button>
                                            </td>
                                            <td>
                                                <button class="btn btn-danger btn-sm"
                                                    wire:click="delete({{ $typesmobile->id }})">
